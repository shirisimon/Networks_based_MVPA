function ct = extractTaskICATimeCourseFromICMapAndVTC(icNum, rootdir, vtc, s, params)

if ~params.ica.sogica
    rest1 = findFilesBVQX([rootdir 'data\' s '\bd1\'],'*bd1*_TAL.ica',struct('maxdepth',1) );
    ica = BVQXfile(rest1{1});
else 
    ica = BVQXfile([pwd, '\sogICA_bv_task\IND_SogICA_10Subjs_1stBD_27ICs.ica']);
end
